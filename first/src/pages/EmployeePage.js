...
const EmployeePage = () => {
  ...
  return (
    <div className="container-flex bg-blue-200 mx-auto p-4 min-h-screen relative">
      <Navbar handleLogout={handleLogout} />

      <h1 className="text-2xl md:text-3xl lg:text-4xl mb-4">Welcome to the Employee Page</h1>

      <div className="flex flex-wrap">
        
        
          <button
            className="w-1/2 h-20 bg-red-300"
            onClick={() => handleLeaveButtonClick('cl')}
          >
            CL
          </button>
          <button
            className="w-1/2 h-20 bg-blue-300"
          ...
          <button
          className=" w-full h-20 bg-gray-300 rounded-full"
          onClick={handleTotalButtonClick}
        >
          Total
        </button>
          ...
          <button
            className="w-1/2 h-20 bg-green-300"
          ...
          <button
            className="w-1/2 h-20 bg-yellow-300"
